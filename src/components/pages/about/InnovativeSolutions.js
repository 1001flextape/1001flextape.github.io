...
import churchImage from '../../../images/church-technology.jpg'; // Example image
            ...
            <ContentBox>
              {startAnimation && (
                <>
                  ...
                  <FadeInTypography variant="body2" sx={{ mb: theme.spacing(1) }} delay={0.9}>
